...
# Assuming the JSON data is stored in a file named 'caption_evaluations.json'
# If you're working with the string directly, you can use json.loads() instead
...
def process_high_similarity_images(image_folder, output_folder, threshold=90):
    ...
    try:
        font = ImageFont.truetype("arial.ttf", 30)  # Use a common font, adjust size as needed
    except:
