...
def get_argument_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help=("The huggingface token for logging in."),
    )
    parser.add_argument(
        "--strategy_reweighting",
        type=str,
        default="none",
        choices=["none", "lognorm", "modesample", "cosmap"],
        help=("loss reweighting"),
    )
    parser.add_argument(
        "--adabas_buffer_size",
        type=int,
        default=1000,
        help=("buffer size in Adaptive Boundary-Aware Sampling"),
    )
    parser.add_argument(
        "--adabas_xi_minus",
        type=float,
        default=0.1,
        help=("xi_minus in Adaptive Boundary-Aware Sampling"),
    )
    parser.add_argument(
        "--adabas_xi_plus",
        type=float,
        default=1.,
        help=("xi_plus in Adaptive Boundary-Aware Sampling"),
    )
    parser.add_argument(
        "--tsaw_buffer_size",
        type=int,
        default=1000,
        help=("buffer size in TSAW"),
    )
    parser.add_argument(
        "--tsaw_alpha",
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        default=5,
        help="Alpha for GeodesicFlow",
    )
    parser.add_argument(
        "--geodesicflow_beta",
        type=float,
        default=10,
        help="Beta for GeodesicFlow",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help=("lambda curvature"),
    )
    parser.add_argument(
        "--no_curveflow",
        action="store_false",
        dest="curveflow_enabled",
        default=True,
        help="Disable curveflow (enabled by default)."
    )
    parser.add_argument(
        "--curveflow_m_grid_size",
        type=int,
        default=1000,
        help=("m grid size in curveflow"),
    )
    parser.add_argument(
        "--curveflow_kappa_samples",
        type=int,
        default=128,
        help=("kappa samples in curveflow"),
    )
    parser.add_argument(
        "--curveflow_hidden_dim",
        type=int,
        default=64,
        help=("hidden dimension in curveflow"),
    )
    parser.add_argument(
        "--curvature_adaptive_alpha",
        type=float,
        default=1.0,
        help=("adaptive alpha curvature"),
    )
    parser.add_argument(
        "--curvature_enabled",
        action="store_true",
        help=(
            "Whether or not to use curveflow for curvature estimation. This is experimental and may not work in all cases."
        ),
    )
    parser.add_argument(
        "--curveflow_learning_rate",
        type=float,
        default=1e-5,
        help=(
            "Initial learning rate (after the potential warmup period) to use."
